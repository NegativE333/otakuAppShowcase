const styles = {
    ...
    boxClass: " flex-col lg:flex-row md:flex-col",
    boxReverseClass: "flex-row-reverse md:flex-col-reverse",
  
    textLeft: "text-center md:text-center lg:text-left",
    textRight: "text-center md:text-center lg:text-right",
  
    h1Text:
      "font-bold font-IBMPlex md:text-1xl lg:text-5xl sm:text-3xl minmd:text-6xl minlg:text-8xl leading-12 minmd:leading-13",
    pText:
    ...
    section: "flex justify-center items-center md:p-4 lg:p-16 sm:p-2",
    subSection: "flex items-center w-full minmd:w-3/4",
    descDiv: "flex-1 w-full flex lg:justify-start flex-col md:mb-10 ",
    ...
    featureImg: "w-20 h-20 minlg:w-40 minlg:h-40 object-contain lg:mb-1",
    featureText:
      "font-semibold font-IBMPlex text-base minlg:text-3xl text-tertiary",
    featureCard:
      "bg-white md:m-6 lg:m-10 p-6 rounded-md flex justify-around items-center flex-col hover:shadow-lg cursor-pointer w-40 h-40 minlg:w-80 minlg:h-80",
  };
